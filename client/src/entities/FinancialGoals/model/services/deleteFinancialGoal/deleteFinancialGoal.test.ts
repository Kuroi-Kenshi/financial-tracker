...
describe('deleteFinancialGoal thunk tests', () => {
  ...
  test('deleteFinancialGoal fulfilled', async () => {
    const data = {
      id: 1,
    };
    ...
    const action = deleteFinancialGoal(1);
  ...
  test('deleteFinancialGoal rejected', async () => {
